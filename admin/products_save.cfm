...
<cfset form.is_featured = iif(listFindNoCase(form.is_featured, "1"), 1, 0)>
  ...
  <cfif val(form.product_id)>
    ...
    <cfquery datasource="#application.dsn#">
      UPDATE products SET
        ...
        description = <cfqueryparam value="#trim(form.description)#" cfsqltype="cf_sql_longvarchar">,
        specs       = <cfqueryparam value="#trim(form.specs)#"       cfsqltype="cf_sql_longvarchar">,
        ...
        is_featured = <cfqueryparam value="#form.is_featured#"       cfsqltype="cf_sql_tinyint">,
  ...
  <cfelse>
    ...
    <cfquery datasource="#application.dsn#">
      INSERT INTO products
        (category, name, item_number, description, specs, image, badge, is_active, is_featured, sort_order, created_at, updated_at)
      VALUES (
        ...
        <cfqueryparam value="#trim(form.description)#" cfsqltype="cf_sql_longvarchar">,
        <cfqueryparam value="#trim(form.specs)#"       cfsqltype="cf_sql_longvarchar">,
        ...
        <cfqueryparam value="#form.is_featured#"       cfsqltype="cf_sql_tinyint">,
